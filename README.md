...
Encrypted inference for Transformer architectures like BERT can be implemented in various ways on various backends. Currently, the harness follows the method of the paper named THOR [[MYJK25](https://doi.org/10.1145/3719027.3765150)] and uses the [DESILO FHE library](https://fhe.desilo.dev) as the backend.
